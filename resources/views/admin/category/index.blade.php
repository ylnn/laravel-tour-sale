...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
      ...
      <div class="btn-toolbar mb-2 mb-md-0">
        ...
        <a href="{{ route('admin.category.create') }}" class="btn btn-sm btn-outline-secondary">+ @lang('admin.new')</a>
        </div>
      ...
      <form method="get">
        <div class="search-form">
          <div class="row">
            ...
            <div class="col-2">
              <button type="submit" class="btn btn-primary btn-sm">@lang('admin.apply-filter')</button>
            </div>
          </div>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              <th>#</th>
              <th><a href="?q={{$q}}&o=<?php echo $o == 40 ? "41" : "40";?>">@lang('admin.status') </a></th>
              <th><a href="?q={{$q}}&o=<?php echo $o == 10 ? "11" : "10";?>">@lang('admin.name') </a></th>
              <th><a href="?q={{$q}}&o=<?php echo $o == 20 ? "21" : "20";?>">@lang('admin.add')</a></th>
              <th><a href="?q={{$q}}&o=<?php echo $o == 30 ? "31" : "30";?>">@lang('admin.update') </a></th>
