...
Vue.component('photo-upload-component', __webpack_require__(48));
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getPhotos: function getPhotos() {
            axios.get('/admin/pages/get_photos_json/' + this.page_id).then(function (response) {
        ...
        post: function post() {
            ...
            try {
                for (var _iterator = this.uploadPhotos[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    axios.post('/admin/pages/photo_upload', data).then(function (response) {
        ...
        onDelete: function onDelete(photoid) {
            ...
            axios.post('/admin/pages/photo/delete', { 'id': photoid }).then(function (response) {
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c("hr"),
    _vm._v(" "),
    _c("button", { staticClass: "btn btn-info", on: { click: _vm.getir } }, [
    ...
    _c(
      ...
      _vm._l(_vm.photos, function(photo) {
        return _c("li", { key: photo.id }, [
          _c("img", {
            staticClass: "img img-responsive",
            attrs: {
              src: "/storage/entry_images_thumbs/" + photo.thumb_filename
            }
          }),
          _vm._v(" "),
          _c(
    ...
    return _c("div", { staticClass: "col-md-4" }, [
      _c("div", { staticClass: "form-group" }, [
        _c(
          ...
          [_c("i", { staticClass: "fa fa-upload" }), _vm._v(" Yükle")]
        )
      ])
    ])
  }
